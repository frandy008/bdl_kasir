    ...
    <div class="all-content-wrapper">
        ...
        <div class="basic-form-area mg-b-15">
            <div class="container-fluid">
                ...
                if (isset($_GET['id'])) {
                    $q = mysqli_fetch_array(mysqli_query($koneksi,"SELECT * FROM tbl_penyalur WHERE id_penyalur = '$_GET[id]'"));
                    $id_penyalur = $q['id_penyalur'];
                    $nama = $q['nama_penyalur'];
                    $alamat = $q['alamat'];
                    $no_hp = $q['no_hp'];
                    $mode = 'update';
                }else{
                                        ...
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <div class="all-form-element-inner">
                                                <form action="#" class="form">
                                                    <input type="hidden" name="id_penyalur" value="<?php echo $id_penyalur ?>">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-lg-9">
                                                                    <div class="login-horizental cancel-wp pull-left form-bc-ele">
                                                                        <button class="btn btn-sm btn-primary login-submit-cs btnSimpan" data-p="reseller" type="button">Simpan</button>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
