    ...
    <div class="all-content-wrapper">
        ...
        <div class="basic-form-area mg-b-15">
            <div class="container-fluid">
                ...
                if (isset($_GET['id'])) {
                    $q = mysqli_fetch_array(mysqli_query($koneksi,"SELECT * FROM tbl_satuan WHERE id_satuan = '$_GET[id]'"));
                    $id_satuan = $q['id_satuan'];
                    $satuan = $q['satuan'];
                    $mode = 'update';
                }else{
                    $id_satuan = '';
                                                    ...
                                                    <div class="form-group-inner">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                                                                <input type="text" class="form-control" value="<?php echo $satuan ?>" name="satuan" />
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="form-group-inner">
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-lg-9">
                                                                    <div class="login-horizental cancel-wp pull-left form-bc-ele">
                                                                        <button class="btn btn-sm btn-primary login-submit-cs btnSimpan" data-p="satuan" type="button">Simpan</button>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
