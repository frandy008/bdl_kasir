                                                ...
                                                <form action="#" class="form" name="form">
                                                    <div class="form-group-inner">
                                                        ...
                                                        <select class="form-control" name="bulan">
                                                            <?php  
                                                            $bulan = mysqli_query($koneksi,"SELECT DISTINCT DATE_FORMAT(tanggal,'%M %Y') AS bulan FROM tbl_pesanan");
                                                            while ($b = mysqli_fetch_array($bulan)) {
                                                            ?>
                                                            <option><?php echo $b['bulan'] ?></option>
                                                            <?php } ?>
                                                        </select>
                                                    </div>
                                                    <div class="form-group-inner">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-lg-2 col-sm-2 col-xs-3">
                                                                    <div class="login-horizental cancel-wp pull-left form-bc-ele">
                                                                        <button class="btn btn-sm btn-primary login-submit-cs" type="button" onclick="document.form.action = 'laporan/lap_laba_rugi.php'; document.form.method='get'; document.form.target='_BLANK'; document.form.submit(); return false;">Print</button>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
