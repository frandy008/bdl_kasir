    ...
    <div class="all-content-wrapper">
        ...
        <div class="basic-form-area mg-b-15">
            <div class="container-fluid">
                ...
                if (isset($_GET['id'])) {
                    $q = mysqli_fetch_array(mysqli_query($koneksi,"SELECT * FROM tbl_kategori WHERE id_kategori = '$_GET[id]'"));
                    $id_kategori = $q['id_kategori'];
                    $kategori = $q['kategori'];
                    $mode = 'update';
                }else{
                    $id_kategori = '';
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-lg-9">
                                                                    <div class="login-horizental cancel-wp pull-left form-bc-ele">
                                                                        <button class="btn btn-sm btn-primary login-submit-cs btnSimpan" data-p="kategori" type="button">Simpan</button>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
