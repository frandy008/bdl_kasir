    ...
    <div class="all-content-wrapper">
        ...
        <div class="basic-form-area mg-b-15">
            <div class="container-fluid">
                ...
                if (isset($_GET['id'])) {
                    $q = mysqli_fetch_array(mysqli_query($koneksi,"SELECT * FROM tbl_brand WHERE id_brand = '$_GET[id]'"));
                    $id_brand = $q['id_brand'];
                    $brand = $q['brand'];
                    $mode = 'update';
                }else{
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-lg-9">
                                                                    <div class="login-horizental cancel-wp pull-left form-bc-ele">
                                                                        <button class="btn btn-sm btn-primary login-submit-cs btnSimpan" data-p="brand" type="button">Simpan</button>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
