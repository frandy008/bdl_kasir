                                            ...
                                            <div class="all-form-element-inner">
                                                <form action="#" class="form">
                                                    <div class="form-group-inner">
                                                        ...
                                                        <input class="form-control" placeholder="Nama Printer (Lihat di control panel)" name="printer" />
                                                    </div>
                                                    <div class="form-group-inner">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-lg-9">
                                                                    <div class="login-horizental cancel-wp pull-left form-bc-ele">
                                                                        <button class="btn btn-sm btn-primary login-submit-cs btnSimpanPrinter"
