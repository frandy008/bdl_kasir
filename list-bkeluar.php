                        ...
                        <div class="sparkline13-list">
                            <div class="sparkline13-hd">
                                <div class="main-sparkline13-hd">
                                    <h1>Data <span class="table-project-n">Barang Keluar</span> / <a href="_bkeluar.php">Tambah</a></h1>
                                </div>
                            </div>
                            <div class="sparkline13-graph">
                                <div class="datatable-dashv1-list custom-datatable-overright">
                                    ...
                                    $q = mysqli_query($koneksi,"SELECT *, DATE_FORMAT(tanggal,'%d-%m-%Y') AS tanggal FROM tbl_inventory WHERE jenis = '2'");
                                    ?>
                                    <table id="table" data-toggle="table" data-pagination="false" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="false" data-show-toggle="false" data-resizable="true" data-cookie="true"
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td></td>
                                                <td><?php echo $no++ ?></td>
                                                <td><?php $p = mysqli_fetch_array(mysqli_query($koneksi,"SELECT * FROM tbl_produk WHERE id_produk = '$data[id_produk]'")); echo $p['nama']; ?></td>
                                                ...
                                                <td style="text-align:center;">
                                                    <a class="btn btn-xs btn-warning" href="_bkeluar.php?id=<?php echo $data['id'] ?>" title="Edit"><span class="fa fa-edit"></span> Edit</a>
                                                    <a class="btn btn-xs btn-danger btnHapus" href="#modalHapus" data-nama="<?php echo $p['nama'] ?>" data-id="<?php echo $data['id'] ?>" data-p="bkeluar" data-toggle="modal" title="Hapus"><span class="fa fa-close"></span> Hapus</a>
                                                </td>
                                            </tr>
                                            <?php } ?>
                                        </tbody>
