...
<body>
                                                    ...
                                                    <div class="all-form-element-inner">
                                                        <form action="#" class="form-id">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-md-5">
                                                                        <input class="form-control input-id" tabindex="1" onchange="cari_produk(2)" name="kode_produk" />
                                                                    </div>
                                            ...
                                            <div class="all-form-element-inner">
                                                <form action="#" class="form-detail">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control total_belanja" readonly="" />
                                                    </div>
                                                    <div class="form-group">
                                                        <label>ID Anggota (<span id="nama_reseller"></span>)</label>
                                                        <input class="form-control" name="id_anggota" tabindex="2" onfocusout="cari_anggota()" />
                                                    </div>
                                                    <div class="form-group">
                                                        <label>Potongan</label>
                                                        <input class="form-control" type="number" name="potongan" tabindex="3" />
                                                    </div>
                                                    <div class="form-group">
                                                        <label>Tunai</label>
                                                        <input class="form-control tunai" type="number" onkeypress="$('.tombolProses').removeAttr('hidden')" name="tunai" tabindex="4" />
                                                    </div>
                                                    <div class="form-group">
                                                        <label>Kembalian</label>
                                                        <input class="form-control kembalian" name="kembalian" readonly="" />
                                                        <input class="form-control" type="hidden" name="kembalian_simpan" />
                                                    </div>
                                                    <div class="form-group">
                                                        <label>Total Hutang</label>
                                                        <input type="hidden" class="hutang" name="hutang_simpan">
                                                        <input class="form-control hutang" name="hutang" readonly="" />
                                                    </div>
                                                    <div class="form-group tombolProses" hidden="">
                                                        <a href="#" data-toggle="modal" data-target="#modalProses"><button class="btn btn-sm btn-success btnProsesPenjualan" disabled="" type="button">Proses</button></a>
                                                    </div>
                                                </form>
                                            </div>
                                        </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer warning-md">
                    ...
                    <a href="#" id="tombol_cetak" target="_BLANK" onclick="proses_pesanan(2)">Cetak dan Proses</a>
                    <?php }else{ ?>
                    <a href="#" id="" onclick="cetak(2)">Cetak dan Proses</a>
                    <?php } ?>
                </div>
            </div>
        </div>
    ...
    <script type="text/javascript">
        ...
        $('.tunai').on('keyup', function(){
            let kembalian = $('.tunai').val()-($('.total_belanja').val()-$('input[name="potongan"]').val())-$('input[name="hutang_simpan"]').val();
            
            var potongan = $('input[name="potongan"]').val();
            var total=$('.total_belanja').val()-potongan;
            var jumuang=$('.tunai').val();
            var dis=0;
            var hsl=jumuang;
            var hutang = $('input[name="hutang_simpan"]').val();
            var total_hutang = parseInt(total)+parseInt(hutang);
            var kem = hsl-(total_hutang);
            var sisa_hutang = (total_hutang)-hsl;
            if (sisa_hutang < 0) {
                $('input[name="hutang"]').val(0);
            }else{
                $('input[name="hutang"]').val(sisa_hutang);
            }
            if (kem < 0) {
                $('.kembalian').val(0);
            }else{
            ...
            $('input[name="kembalian_simpan"]').val(kem);
