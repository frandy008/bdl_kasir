    ...
    <div class="all-content-wrapper">
        ...
        <div class="basic-form-area mg-b-15">
            <div class="container-fluid">
                ...
                if (isset($_GET['id'])) {
                    $q = mysqli_fetch_array(mysqli_query($koneksi,"SELECT * FROM tbl_suplier WHERE id_suplier = '$_GET[id]'"));
                    $id_suplier = $q['id_suplier'];
                    $nama = $q['nama'];
                    $alamat = $q['alamat'];
                    $no_hp = $q['no_hp'];
                    $mode = 'update';
                                        ...
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <div class="all-form-element-inner">
                                                <form action="#" class="form">
                                                    ...
                                                    <div class="form-group-inner">
                                                        <label>Alamat</label>
                                                        <textarea type="text" class="form-control" name="alamat" rows="5"><?php echo $alamat ?></textarea>
                                                    </div>
                                                    <div class="form-group-inner">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-lg-9">
                                                                    <div class="login-horizental cancel-wp pull-left form-bc-ele">
                                                                        <button class="btn btn-sm btn-primary login-submit-cs btnSimpan" data-p="suplier" type="button">Simpan</button>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
