                                                            ...
                                                            <div class="row">
                                                                <div class="col-lg-2 col-sm-2 col-xs-3">
                                                                    <div class="login-horizental cancel-wp pull-left form-bc-ele">
                                                                        <button class="btn btn-sm btn-primary login-submit-cs" type="button" onclick="document.form.action = 'laporan/lap_penjualan.php'; document.form.method='get'; document.form.target='_BLANK'; document.form.submit(); return false;">Print</button>
                                                                    </div>
                                                                </div>
                                                                <div class="col-lg-2 col-sm-2 col-xs-3">
                                                                    <div class="login-horizental cancel-wp pull-left form-bc-ele">
                                                                        <button class="btn btn-sm btn-primary login-submit-cs" type="button" onclick="document.form.action = 'laporan/lap_penjualan_excel.php'; document.form.method='get'; document.form.submit(); return false;">Export</button>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
