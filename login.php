	...
	<div class="error-pagewrap">
		<div class="error-page-int">
                    ...
                    <div class="panel-body">
                        <form action="#" id="loginForm">
                            <div class="form-group">
                                ...
                                <input type="text" placeholder="Masukan username" title="Silahkan masukan username" required="" value="" name="username" id="username" class="form-control">
                            </div>
                            <div class="form-group">
                                <label class="control-label" for="password">Password</label>
                                <input type="password" title="Masukan password" placeholder="******" required="" value="" name="password" id="password" class="form-control">
                            </div>
			...
			<div class="text-center login-footer">
				<p>Copyright © 2020. All rights reserved. Designed by <a href="https://instagram.com/frandy008/">IMFDP</a></p>
			</div>
		</div>   
    </div>
    <!-- jquery
