                        ...
                        <div class="sparkline13-list">
                            <div class="sparkline13-hd">
                                <div class="main-sparkline13-hd">
                                    <h1>Data <span class="table-project-n">Stok Barang</span></h1>
                                </div>
                            </div>
                            <div class="sparkline13-graph">
                                <div class="datatable-dashv1-list custom-datatable-overright">
                                    ...
                                    $q = mysqli_query($koneksi,"SELECT * FROM tbl_produk");
                                    ?>
                                    <table id="table" data-toggle="table" data-pagination="false" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="false" data-show-toggle="false" data-resizable="true" data-cookie="true"
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th>No</th>
                                                <th data-field="kode_produk" data-editable="false">Kode Produk</th>
                                                <th data-field="nama" data-editable="false">Nama</th>
                                                <th data-field="brand" data-editable="false">Brand</th>
                                                <th data-field="stok" data-editable="false">Stok</th>
                                                <th data-field="satuan" data-editable="false">Satuan</th>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <?php $b = mysqli_fetch_array(mysqli_query($koneksi,"SELECT * FROM tbl_brand WHERE id_brand = '$data[id_brand]'")); echo $b['brand']; ?>
                                                </td>
                                                <td>
                                                    <?php 
                                                ...
                                                <td>
                                                    <?php $s = mysqli_fetch_array(mysqli_query($koneksi,"SELECT * FROM tbl_satuan WHERE id_satuan = '$data[id_satuan]'")); echo $s['satuan']; ?>
                                                </td>
                                                <td><?php $k = mysqli_fetch_array(mysqli_query($koneksi,"SELECT * FROM tbl_kategori WHERE id_kategori = '$data[id_kategori]'")); echo $k['kategori']; ?></td>
                                            </tr>
                                            <?php } ?>
                                        </tbody>
                                    </table>
