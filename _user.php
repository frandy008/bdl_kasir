    ...
    <div class="all-content-wrapper">
        ...
        <div class="basic-form-area mg-b-15">
            <div class="container-fluid">
                ...
                if (isset($_GET['id'])) {
                    $q = mysqli_fetch_array(mysqli_query($koneksi,"SELECT * FROM tbl_user WHERE id_user = '$_GET[id]'"));
                    $username = $q['username'];
                    $nama = $q['nama'];
                    $level = $q['id_level'];
                    $mode = 'update';
                                        ...
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <div class="all-form-element-inner">
                                                <form action="#" class="form">
                                                    ...
                                                    <div class="form-group" <?php if ($username != '') { echo 'hidden=""'; } ?>>
                                                    ...
                                                    <div class="form-group-inner">
                                                        ...
                                                        <select class="form-control" name="id_level" required="">
                                                            ...
                                                            <?php  
                                                            $sl = mysqli_query($koneksi,"SELECT * FROM tbl_level");
                                                            while ($l = mysqli_fetch_array($sl)) {
                                                            ?>
                                                            <option <?php if ($l['id_level'] == '0') { echo 'hidden=""'; } ?> value="<?php echo $l['id_level'] ?>" <?php if ($l['id_level'] == $level) { echo 'selected=""';} ?>><?php echo $l['level'] ?></option>
                                                            <?php } ?>
                                                        </select>
                                                    </div>
                                                    <div class="form-group-inner">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-lg-9">
                                                                    <div class="login-horizental cancel-wp pull-left form-bc-ele">
                                                                        <button class="btn btn-sm btn-primary login-submit-cs btnSimpan" data-p="user" type="button">Save</button>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
