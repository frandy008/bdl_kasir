                        ...
                        <div class="sparkline13-list">
                            ...
                            <div class="sparkline13-graph">
                                <div class="datatable-dashv1-list custom-datatable-overright">
                                    ...
                                    $q = mysqli_query($koneksi,"SELECT * FROM tbl_user WHERE id_level != '0'");
                                    ?>
                                    <table id="table" data-toggle="table" data-pagination="false" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="false" data-show-toggle="false" data-resizable="true" data-cookie="true"
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <?php 
                                                    $level = mysqli_fetch_array(mysqli_query($koneksi,"SELECT * FROM tbl_level WHERE id_level='$data[id_level]'"));
                                                    echo $level['level']; 
                                                    ?>
                                                </td>
                                                <td style="text-align:center;">
                                                    <a class="btn btn-xs btn-warning" href="_user.php?id=<?php echo $data['id_user'] ?>" title="Edit"><span class="fa fa-edit"></span> Edit</a>
                                                    <a class="btn btn-xs btn-danger btnHapus" href="#modalHapus" data-nama="<?php echo $data['username'] ?>" data-id="<?php echo $data['id_user'] ?>" data-p="user" data-toggle="modal" title="Hapus"><span class="fa fa-close"></span> Hapus</a>
                                                </td>
                                            </tr>
                                            <?php } ?>
                                        </tbody>
