...
<?php $b=mysql_fetch_array(mysql_query("SELECT kode_pesanan,DATE_FORMAT(tanggal,'%d-%m-%Y') AS tanggal,total,tunai,ppn,kembalian FROM tbl_pesanan WHERE kode_pesanan='$_GET[id]'")); ?>
	<center>
		...
		<table width="211px">
			...
			<tfoot>
				...
				<tr hidden="">
					<td colspan="2" align="center">Total Hutang</td>
