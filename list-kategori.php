                        ...
                        <div class="sparkline13-list">
                            <div class="sparkline13-hd">
                                <div class="main-sparkline13-hd">
                                    <h1>Data <span class="table-project-n">Kategori</span></h1>
                                </div>
                            </div>
                                    ...
                                    <table id="table" data-toggle="table" data-pagination="false" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="false" data-show-toggle="false" data-resizable="true" data-cookie="true"
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th>No</th>
                                                <th data-field="brand" data-editable="false">Kategori</th>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td style="text-align:center;">
                                                    <a class="btn btn-xs btn-warning" href="_kategori.php?id=<?php echo $data['id_kategori'] ?>" title="Edit"><span class="fa fa-edit"></span> Edit</a>
                                                    <a class="btn btn-xs btn-danger btnHapus" href="#modalHapus" data-nama="<?php echo $data['kategori'] ?>" data-id="<?php echo $data['id_kategori'] ?>" data-p="kategori" data-toggle="modal" title="Hapus"><span class="fa fa-close"></span> Hapus</a>
                                                </td>
                                            </tr>
                                            <?php } ?>
                                        </tbody>
