                        ...
                        <div class="sparkline13-list">
                            ...
                            <div class="sparkline13-graph">
                                <div class="datatable-dashv1-list custom-datatable-overright">
                                    ...
                                    $q = mysqli_query($koneksi,"SELECT * FROM tbl_level WHERE id_level != 0 AND id_level!=1");
                                    ?>
                                    <table id="table" data-toggle="table" data-pagination="false" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="false" data-show-toggle="false" data-resizable="true" data-cookie="true"
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th>No</th>
                                                <th data-field="username" data-editable="false">Level</th>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td style="text-align:center;">
                                                    <a class="btn btn-xs btn-warning" href="_permision.php?id=<?php echo $data['id_level'] ?>" title="Edit"><span class="fa fa-edit"></span> Edit</a>
                                                </td>
                                            </tr>
                                            <?php } ?>
                                        </tbody>
