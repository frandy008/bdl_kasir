                        ...
                        <div class="sparkline13-list">
                            <div class="sparkline13-hd">
                                <div class="main-sparkline13-hd">
                                    <h1>Data <span class="table-project-n">Suplier</span></h1>
                                </div>
                            </div>
                            <div class="sparkline13-graph">
                                <div class="datatable-dashv1-list custom-datatable-overright">
                                    ...
                                    $q = mysqli_query($koneksi,"SELECT * FROM tbl_suplier");
                                    ?>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td style="text-align:center;">
                                                    <a class="btn btn-xs btn-warning" href="_suplier.php?id=<?php echo $data['id_suplier'] ?>" title="Edit"><span class="fa fa-edit"></span> Edit</a>
                                                    <a class="btn btn-xs btn-danger btnHapus" href="#modalHapus" data-nama="<?php echo $data['nama'] ?>" data-id="<?php echo $data['id_suplier'] ?>" data-p="suplier" data-toggle="modal" title="Hapus"><span class="fa fa-close"></span> Hapus</a>
                                                </td>
                                            </tr>
                                            <?php } ?>
                                        </tbody>
